...
describe("Deep clone object", () => {
    ...
    test("Object with tree levels", () => {
        ...
        expect(originObject).not.toEqual(clonedObject);
        expect(originObject.object.object.string).not.toBe(clonedObject.object.object.string);
        expect(originObject.object.object.number).not.toBe(clonedObject.object.object.number);
        expect(originObject.object.object.boolean).not.toBe(clonedObject.object.object.boolean);
    });
    ...
    test("Object with array of objects", () => {
        ...
        expect(originObject.array[0].boolean).not.toBe(clonedObject.array[0].boolean);
    });
