...
describe("FormField", () => {
    ...
    test("Default functionality", () => {
        ...
        render(
            <context.Provider value={privateController}>
                <FieldContainer $controller={controller} $name="input" data-testid={testId} fieldType="input" />
            </context.Provider>
        );
    ...
    test("Providing wrong disableIf should throw an error", () => {
        ...
        values.forEach((value) => {
            expect(() => {
                render(
                    <context.Provider value={privateController}>
                        <FieldContainer $controller={controller} $disableIf={value} fieldType="input" $name="input" />
                    </context.Provider>
                );
            }).toThrowError();
        });
    ...
    test("Providing wrong name should throw an error", () => {
        ...
        values.forEach((value) => {
            expect(() => {
                render(
                    <context.Provider value={privateController}>
                        <FieldContainer $controller={controller} fieldType="input" $name={value} />
                    </context.Provider>
                );
            }).toThrowError();
        });
    ...
    test("Providing wrong validate should throw an error", () => {
        ...
        values.forEach((value) => {
            expect(() => {
                render(
                    <context.Provider value={privateController}>
                        <FieldContainer $controller={controller} fieldType="input" $name="input" $validation={value} />
                    </context.Provider>
                );
            }).toThrowError();
        });
    ...
    describe("Name checking", () => {
        test("Providing different name or radios with same name should not log a warning", () => {
            ...
            render(
                <context.Provider value={privateController}>
                    <FieldContainer $controller={controller} fieldType="input" $name="input" />
                    <FieldContainer $controller={controller} fieldType="input" $name="name" />
                    <FieldContainer
                        $controller={controller}
                        fieldType="input"
                        $label="radio 1"
    ...
    describe("hideIf", () => {
        ...
        test("HideIf should be passed", () => {
            ...
            render(
                <context.Provider value={privateController}>
                    <FieldContainer $controller={controller} fieldType="input" $hideIf={hideIfPassed} $name="input" />
                </context.Provider>
            );
    ...
    describe("initialState", () => {
        ...
        test("IsDisabled", () => {
            ...
            render(
                <context.Provider value={privateController}>
                    <FieldContainer $controller={controller} $disableIf={() => true} fieldType="input" $name="input" />
                </context.Provider>
            );
        ...
        test("IsVisible", () => {
            ...
            render(
                <context.Provider value={privateController}>
                    <FieldContainer $controller={controller} fieldType="input" $hideIf={() => true} $name="input" />
                </context.Provider>
            );
    ...
    describe("initialValidation", () => {
        test("Default", () => {
            ...
            render(
                <context.Provider value={privateController}>
                    <FieldContainer $controller={controller} $initialValidation fieldType="input" $name="input" />
                </context.Provider>
            );
