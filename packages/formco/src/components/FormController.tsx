...
export const FormController = <T extends FormFields<T>>(props: FormControllerComponentProps<T>) => {
    if (
        props.initialValues !== undefined &&
        (typeof props.initialValues !== "object" || props.initialValues === null || Array.isArray(props.initialValues))
    ) {
