...
describe("Value Generator", () => {
    ...
    test("bigint", () => {
        ...
        expect(result.every((item: BigInt) => typeof item === "bigint")).toBeTruthy();
    ...
    test("boolean", () => {
        ...
        expect(result.every((item: Boolean) => typeof item === "boolean")).toBeTruthy();
    ...
    test("class", () => {
        ...
        expect(result.every((item: TestClass) => item instanceof TestClass)).toBeTruthy();
    ...
    test("float", () => {
        ...
        expect(
            result.every((item: number) => item === 0.0 || item.toString().match(/^(-)?[0-9]+\.[0-9]+$/) !== null)
        ).toBeTruthy();
    ...
    test("function", () => {
        ...
        expect(result.every((item: Function) => typeof item === "function")).toBeTruthy();
    ...
    test("integer", () => {
        ...
        expect(result.every((item: number) => typeof item === "number" && Number.isInteger(item))).toBeTruthy();
    ...
    test("number", () => {
        ...
        expect(result.every((item: number) => typeof item === "number")).toBeTruthy();
    ...
    test("object", () => {
        ...
        expect(
            result.every((item: Object) => typeof item === "object" && item !== null && !Array.isArray(item))
        ).toBeTruthy();
        ...
        expect(
            result.every(
                (item: Object) =>
                    !(typeof item === "object" && item !== null && !Array.isArray(item)) || item instanceof TestClass
            )
        ).toBeTruthy();
    });
    ...
    test("string", () => {
        ...
        expect(result.every((item: string) => typeof item === "string")).toBeTruthy();
    ...
    test("symbol", () => {
        ...
        expect(result.every((item: symbol) => typeof item === "symbol")).toBeTruthy();
    ...
    test("Multiple", () => {
        ...
        expect(result.every((item: string | []) => typeof item === "string" || Array.isArray(item))).toBeTruthy();
