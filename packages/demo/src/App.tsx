...
export const App = () => {
    const [selectedKey, setSelectedKey] = React.useState(getHash() || menuItemsWithKey["About Examples"][0].key);
                    ...
                    {Object.keys(menuItemsWithKey).map((key, index) => {
                        return (
                            <React.Fragment key={index}>
                                ...
                                {menuItemsWithKey[key as keyof typeof menuItemsWithKey].map((item, index) => {
                                    return (
