...
export const TextFieldDisabledUseCase1 = (props: Partial<React.ComponentProps<typeof FormController>>) => {
            ...
            <FormController<MyForm> validateOnChange {...props} onSubmit={(fields) => console.log(fields)}>
                {(controller) => (
                    <>
                        ...
                        <Info>
                            * Salutation is disabled until the surname is not valid, the surname is disabled until the
                            first name is not valid and the submit button is disabled until all text fields are filled
                        </Info>
                    </>
                )}
            </FormController>
