...
export const CheckboxFieldDefaultValues = (props: Partial<React.ComponentProps<typeof FormController>>) => {
            ...
            >
                {(controller) => (
                    <>
                        ...
                        <Info>
                            * The second checkbox is checked by default and required to be checked for submitting the
                            form
                        </Info>
                    </>
                )}
